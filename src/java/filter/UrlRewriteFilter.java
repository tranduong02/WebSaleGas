...
//
//        if (requestURI.startsWith("/salegas")) {
//            String productID = req.getParameter("productID");
//            String encodedValue = req.getParameter("productName");
//
//            if (productID != null && encodedValue != null) {
//                try {
//                    String decodedValue = URLDecoder.decode(encodedValue, "UTF-8");
//                    String normalizedValue = removeAccents(decodedValue);
//                    String lowercaseValue = normalizedValue.toLowerCase();
//                    String replacedValue = lowercaseValue.replace(" ", "-");
//                    String newURI = "productdetail/" + replacedValue + "-" + productID;
