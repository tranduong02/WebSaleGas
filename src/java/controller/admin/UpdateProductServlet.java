...
public class UpdateProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("dataPoduct", p);
...
//        // Tạo một đường dẫn tuyệt đối của file ảnh trên server
        ...
        try {
            ...
            Product pNew = new Product(productID, categoryID, supplierID, warrantyPeriod, quantity, productName, describe, price, image);
            cdb.updateProduct(pNew);
