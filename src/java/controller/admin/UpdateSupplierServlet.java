...
public class UpdateSupplierServlet extends HttpServlet {
    ...
    private SupplierDAO sdb = new SupplierDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Supplier s = sdb.getAnSupplierByID(supplierID);
            request.setAttribute("anSupplier", s);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Supplier sUpdate = new Supplier(supplierID, status, supplierName, companyName, contactInfor, phoneContact, address, country);
            sdb.updateSupplier(sUpdate);
            
            Supplier s = sdb.getAnSupplierByID(supplierID);
            request.setAttribute("anSupplier", s);
            String mess = "Update supplier successfully!";
