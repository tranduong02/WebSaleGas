...
public class AddSupplierServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Supplier sNew = new Supplier(1, supplierName, companyName, contactInfor, phoneContact, address, country);
            sdb.insertSupplier(sNew);
            String mess = "Add supplier successfully!";
