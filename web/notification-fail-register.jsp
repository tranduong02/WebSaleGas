...
<html>
    ...
    <body>
        <div class="container">
            ...
            <h1 class="notification">Đăng Kí Thất Bại!</h1>
            <p>Rất tiếc, nhưng chúng tôi đã nhận thấy rằng bạn đã nhập sai mã xác nhận quá 5 lần hoặc mã xác nhận đã quá thời gian 5 phút. Vui lòng quay lại trang đăng ký để thử lại. SaleGas thành thật xin lỗi vì sự bất tiện này!</p>
            <a class="btn" href="signup"><i class="fas fa-arrow-left"></i> Quay Về Trang Đăng Kí</a>
        </div>
    </body>
