                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><i class="fas fa-envelope"></i>Email: <a href="mailto:khanhpd2402@gmail.com">khanhpd2402@gmail.com</a></p>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="subject" name="sub" placeholder="Subject" required data-error="Please enter your Subject">
