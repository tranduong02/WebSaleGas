                    ...
                    <div class="">
                        <c:if test="${requestScope.mess != null}">
                            <div class="mess-success"><span>${requestScope.mess}</span></div>
                                ...
                                <c:set value="${requestScope.anSupplier}" var="as"/>
                        <form class="card" name="fus" action="updatesupplier" method="post">
                            <div class="card-header">
                                <strong>Masked Input</strong>
                            </div>
                            <input name="supplierID" value="${as.supplierID}" hidden="">
                            <div class="card-body card-block">
                                <div class="form-group">
                                    <label class=" form-control-label">Supplier Name</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fas fa-tag"></i></div>
                                        <input class="form-control" name="supplierName" value="${as.supplierName}" required="">
                                    </div>    
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" name="companyName" value="${as.companyName}" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control"  name="contactInfor" value="${as.contactInfor}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" name="phoneContact" value="${as.phoneContact}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" name="address" required="" value="${as.address}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="status" id="select" class="form-control">
                                            <option <c:if test="${as.status == 1}">selected=""</c:if> value="1">Đang Hợp Tác</option>
                                            <option <c:if test="${as.status == 0}">selected=""</c:if> value="0">Dừng Hợp Tác</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" value="${as.country}" readonly="">
                                    </div>
                                    <select data-placeholder="Chọn quốc gia..." name="country" class="standardSelect" tabindex="1" required="">
                                        <option  value="${as.country}" label="mặc định"></option>
