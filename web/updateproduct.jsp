<%-- 
    ...
    Created on : May 26, 2023, 8:04:21 PM
    Author     : duykh
--%>
...
<html lang="en">
    ...
    <%
       Product p = (Product) request.getAttribute("dataPoduct");
       List<Category> list = ( List<Category>) request.getAttribute("datac");
       List<Supplier> list1 = (List<Supplier>) request.getAttribute("datas");
    %>
    <body>
            ...
            <div class="container h-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto h-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="listproduct.jsp">
                                <i class="fas fa-shopping-cart"></i> Products
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="accountadmin.jsp">
                ...
                <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        ...
                        <div class="row tm-edit-product-row">
                            <form action="updateproduct?productID=<%= p.getProductID()%>" method="post" 
                                        ...
                                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                                            ...
                                            <select
                                                ...
                                                <% 
                                                    ...
                                                    String sname = sd.getSupplierName(p.getSupplierID());
                                                %>
